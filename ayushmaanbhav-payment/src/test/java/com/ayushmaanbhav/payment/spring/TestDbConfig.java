...
import static com.ayushmaanbhav.gatewayProvider.constant.SpringConstants.PACKAGE_GATEWAY_PROVIDER_ENTITY;
...
public class TestDbConfig {
    ...
    public LocalContainerEntityManagerFactoryBean entityManagerFactoryBean(DataSource dataSource) {
        ...
        entityManagerFactoryBean.setPackagesToScan(PACKAGE_PAYMENTS_ENITY,PACKAGE_GATEWAY_PROVIDER_ENTITY);
